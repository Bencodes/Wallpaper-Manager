...
public abstract class GridFragment extends SherlockFragment implements
		OnItemLongClickListener, OnGetViewListener, OnItemClickListener {
	...
	public void setAdapter(Adapter adapter) {
		...
		this.mGridView.setNumColumns(super.getResources().getInteger(
				R.integer.column_count));
		this.mGridView.setNumRows(super.getResources().getInteger(
				R.integer.column_count));
